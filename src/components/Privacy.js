    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#EAF5F0' }}>
            <View style={{ flex: .4, backgroundColor: 'yellow' }}>
                <ImageBackground source={require('../assets/images/menu-bg.jpeg')} style={{ height: 210 }}>
            ...
            <ScrollView style={{ flex: 1, backgroundColor: "white", marginHorizontal: '3%', marginVertical: '1%', borderWidth: 1, borderColor: '#381290', borderRadius: 10, paddingHorizontal: 5 }}>
                <View>
                    <Text style={{ fontSize: 20, color: '#333' }}>This privacy policy sets out the basis on which any information, including any personal data, we collect from you, or you provide to us, will be processed by Blood Donation .Each time you use the Service by doing so you are accepting and cons-{"\n"}enting to the practices described in this privacy policy.</Text>
                </View>
                <View>
                ...
                <View>
                    <Text style={{ fontSize: 20, color: '#333' }}>This privacy policy (this “privacy policy") applies to persons anywhere in the world who access the application and use the blood donation app</Text>
                </View>
                <View>
                ...
                <View>
                    <Text style={{ fontSize: 20, color: '#333' }}>We collect the information you provide directly to us through your access or use of the Services, such as when you create or modify your account, post a request, or by becoming donor. This information may include your name, email address, phone number, postal address, profile picture, location, and other information you choose to provide</Text>
                </View>
                <View>
                ...
                <View>
                    <Text style={{ fontSize: 20, color: '#333' }}>improve the blood donation service including clear communication b/w donors and users
                ...
                <View>
                    <Text style={{ fontSize: 20, color: '#333' }}>We may share the data which include the phone number ,image , and location
                ...
                <View>
                    <Text style={{ fontSize: 20, color: '#333' }}>Please note that we do not knowingly collect, keep or maintain personal information from children under the age of 18 through the Services, as we require that all users represent to us that they are at least 18 years old</Text>
                </View>
                ...
                <View>
                    <Text style={{ fontSize: 20, color: '#333' }}>We want to inform you that whenever you use our Service, in a case of an error in the app we collect data and information that we use to improve the operation of the application</Text>
                </View>
                ...
                <View>
                    <Text style={{ fontSize: 20, color: '#333' }}>Cookies are files with a small amount of data that are commonly used as anonymous unique identifiers. These are sent to your browser from the websites that you visit and are stored on your device's internal memory. This Service does not use these “cookies” explicitly. However, the app may use third-party code and libraries that use “cookies” to collect information and improve their services. You have the option to either accept or refuse these cookies and know when a cookie is being sent to your device. If you choose to refuse the cookies, you may not be able to use some portions of this Service</Text>
                </View>
                ...
                <View>
                    <Text style={{ fontSize: 20, color: '#333' }}>We may update our Privacy Policy from time to time. Thus, you are advised to review our website page periodically for any changes. These changes are effective immediately after they are posted on this page.</Text>
                </View>
                ...
                <View>
                    <Text style={{ fontSize: 20, color: '#333' }}>If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at faisalabbas3120@gmail.com</Text>
                </View>
            </ScrollView>
